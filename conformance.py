...
CONFORMANCE_TEST_CASE = [
    ...
    ("input/key-press", '{"keyCode": "KEY_HOME"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_HOME", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_VOLUME_UP"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_VOLUME_UP", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_VOLUME_DOWN"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_VOLUME_DOWN", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_MUTE"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_MUTE", "2.0", False),
    ("input/key-press", '{"keyCode": "dummy"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "dummy", "2.0", True),
    ("input/key-press", '{"keyCode": ""}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "null", "2.0", True),
    ("input/key-press", '{"keyCode": "KEY_CHANNEL_UP"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_CHANNEL_UP", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_CHANNEL_DOWN"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_CHANNEL_DOWN", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_MENU"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_MENU", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_EXIT"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_EXIT", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_INFO"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_INFO", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_GUIDE"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_GUIDE", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_CAPTIONS"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_CAPTIONS", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_UP"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_UP", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_PAGE_UP"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_PAGE_UP", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_PAGE_DOWN"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_PAGE_DOWN", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_RIGHT"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_RIGHT", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_DOWN"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_DOWN", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_LEFT"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_LEFT", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_ENTER"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_ENTER", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_BACK"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_BACK", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_PLAY"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_PLAY", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_PLAY_PAUSE"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_PLAY_PAUSE", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_PAUSE"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_PAUSE", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_STOP"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_STOP", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_REWIND"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_REWIND", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_FAST_FORWARD"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_FAST_FORWARD", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_SKIP_REWIND"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_SKIP_REWIND", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_SKIP_FAST_FORWARD"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_SKIP_FAST_FORWARD", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_0"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_0", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_1"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_1", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_2"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_2", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_3"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_3", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_4"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_4", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_5"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_5", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_6"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_6", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_7"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_7", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_8"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_8", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_9"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_9", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_RED"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_RED", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_GREEN"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_GREEN", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_YELLOW"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_YELLOW", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_BLUE"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_BLUE", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_YOUTUBE"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_YOUTUBE", "2.0", False),
    ("input/key-press", '{"keyCode_": "KEY_HOME"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_HOME Bad Request1", "2.0", True),
    ("input/key-press", '{"keyCode": "invalid"}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_HOME Bad Request2", "2.0", True),
    ("input/key-press", '{"keyCode": true}', dab.input.key_press, _KEY_PRESS_LATENCY_MS, "KEY_HOME Bad Request3", "2.0", True),
