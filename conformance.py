...
CONFORMANCE_TEST_CASE = [
    ...
    ("system/settings/set", '{"screenSaver": true}', dab.system.set, 5000, "Set Screen Saver", False),
    ("system/settings/set", '{"screenSaverTimeout": 300}', dab.system.set, 5000, "Set Screen Saver Timeout", False),
    ("system/settings/set", '{"screenSaverMinTimeout": 60}', dab.system.set, 5000, "Set Screen Saver Min Timeout", False),
    ("system/settings/set", '{"personalizedAds": false}', dab.system.set, 5000, "Set Personalized Ads", False),
    ("system/settings/set", '{"highContrastText": true}', dab.system.set, 5000, "Set High Contrast Text", False),
    ...
    ("system/logs/start-collection", '{}', dab.system.start_log_collection, 200, "Conformance", False),
    ("system/logs/stop-collection", '{}', dab.system.stop_log_collection, 200, "Conformance", False),
    ("system/logs/stop-collection", '{}', dab.system.stop_log_collection, 400, "Stop Without Start Negative", True),
]
