...
CONFORMANCE_TEST_CASE = [
    ...
    ("applications/launch",'{{"appId_": "{config.apps["youtube"]}"}}', dab.applications.launch, 10000, "Conformance Bad Request 1", "2.0", True),
    ...
    ("applications/launch",'{{"appId": "{config.apps["youtube"]}", "parameters_": ["v%3DSs75O8yllyc","enableEventConsole%3Dtrue","env_showConsole%3Dtrue"]}}', dab.applications.launch, 10000, "with parameters bad request 1", "2.0", True),
    ("applications/launch",'{{"appId": "{config.apps["youtube"]}", "parameters": true}}', dab.applications.launch, 10000, "with parameters bad request 2", "2.0", True),
    ...
    ("system/settings/list",'{}', dab.system.list, 200, "Conformance", "2.0", False),
    ("system/settings/get",'{}', dab.system.get, 200, "Conformance", "2.0", False),
    ("system/settings/set",'{"language": "en-US"}', dab.system.set, 120000, "language", "2.0", False),
    ("system/settings/set",'{"language_": "en-US"}', dab.system.set, 120000, "language bad request1", "2.0", True),
    ("system/settings/set",'{"language": true}', dab.system.set, 120000, "language bad request2", "2.0", True),
    ("system/settings/set",'{"outputResolution": {"width": 3840, "height": 2160, "frequency": 60} }', dab.system.set, 3000, "outputResolution", "2.0", False),
    ("system/settings/set",'{"outputResolution": "invalid" }', dab.system.set, 3000, "outputResolution bad request", "2.0", True),
    ("system/settings/set",'{"memc": true}', dab.system.set, 3000, "memc", "2.0", False),
    ("system/settings/set",'{"memc": "invalid"}', dab.system.set, 3000, "memc bad request", "2.0", True),
    ("system/settings/set",'{"cec": true}', dab.system.set, 3000, "cec", "2.0", False),
    ("system/settings/set",'{"cec": "invalid"}', dab.system.set, 3000, "cec bad request", "2.0", True),
    ("system/settings/set",'{"lowLatencyMode": true}', dab.system.set, 3000, "lowLatencyMode", "2.0", False),
    ("system/settings/set",'{"lowLatencyMode": "invalid"}', dab.system.set, 3000, "lowLatencyMode Bad Request", "2.0", True),
    ("system/settings/set",'{"matchContentFrameRate": "EnabledSeamlessOnly"}', dab.system.set, 3000, "matchContentFrameRate", "2.0", False),
    ("system/settings/set",'{"matchContentFrameRate": "invalid"}', dab.system.set, 3000, "matchContentFrameRate Bad Request", "2.0", True),
    ("system/settings/set",'{"hdrOutputMode": "AlwaysHdr"}', dab.system.set, 3000, "hdrOutputMode", "2.0", False),
    ("system/settings/set",'{"hdrOutputMode": "invalid"}', dab.system.set, 3000, "hdrOutputMode Bad Request", "2.0", True),
    ("system/settings/set",'{"pictureMode": "Standard"}', dab.system.set, 3000, "pictureMode", "2.0", False),
    ("system/settings/set",'{"pictureMode": "invalid"}', dab.system.set, 3000, "pictureMode Bad Request", "2.0", True),
    ("system/settings/set",'{"audioOutputMode": "Auto"}', dab.system.set, 3000, "audioOutputMode", "2.0", False),
    ("system/settings/set",'{"audioOutputMode": "invalid"}', dab.system.set, 3000, "audioOutputMode Bad Request", "2.0", True),
    ("system/settings/set",'{"audioOutputSource": "HDMI"}', dab.system.set, 3000, "audioOutputSource", "2.0", False),
    ("system/settings/set",'{"audioOutputSource": "invalid"}', dab.system.set, 3000, "audioOutputSource Bad Request", "2.0", True),
    ("system/settings/set",'{"videoInputSource": "HDMI1"}', dab.system.set, 3000, "videoInputSource", "2.0", False),
    ("system/settings/set",'{"videoInputSource": "invalid"}', dab.system.set, 3000, "videoInputSource Bad Request", "2.0", True),
    ("system/settings/set",'{"audioVolume": 10}', dab.system.set, 3000, "audioVolume", "2.0", False),
    ("system/settings/set",'{"audioVolume": 120}', dab.system.set, 3000, "audioVolume - Negative Test", "2.0", True),
    ("system/settings/set",'{"audioVolume": true}', dab.system.set, 3000, "audioVolume bad request", "2.0", True),
    ("system/settings/set",'{"mute": false}', dab.system.set, 3000, "mute", "2.0", False),
    ("system/settings/set",'{"mute": "invalid"}', dab.system.set, 3000, "mute bad request", "2.0", True),
    ("system/settings/set",'{"textToSpeech": true}', dab.system.set, 3000, "textToSpeech", "2.0", False),
    ("system/settings/set",'{"textToSpeech": "invalid"}', dab.system.set, 3000, "textToSpeech bad request", "2.0", True),
    ...
    ("device-telemetry/start",'{"duration": 1000}', dab.device_telemetry.start, 200, "Conformance", "2.0", False),
    ...
    ("applications/install", f'{{"fileLocation": "https://storage.googleapis.com/ytlr-cert.appspot.com/applications/myfile.apk"}}', dab.applications.install, 120000, "Install App Conformance", "2.1", False), 
