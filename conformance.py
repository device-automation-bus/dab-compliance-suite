...
CONFORMANCE_TEST_CASE = [
    ...
    ("input/key-press",'{"keyCode": "KEY_DOWN"}', dab.input.key_press, 1000, "KEY_DOWN", "Launch YT"),
    ...
    ("input/key-press",'{"keyCode": "KEY_0"}', dab.input.key_press, 1000, "KEY_0", "Enter YT search menu"),
    ...
    ("input/long-key-press",'{"keyCode": "KEY_0", "durationMs": 3000}', dab.input.long_key_press, 5000, "KEY_0", "Enter YT search menu"),
