...
Test_Cases = [
    ...
    ("applications/launch",f'{{"appId": "{config.apps["youtube"]}", "parameters": "v=jfKfPfyJRdk"}}', dab.applications.launch, 10000),
    ("applications/launch-with-content",f'{{"appId": "{config.apps["youtube"]}", "contentId": "jfKfPfyJRdk"}}', dab.applications.launch_with_content, 10000),
