...
Test Result Types:
  ...
  SKIPPED           → Internal issue --> test incomplete retry is required. (e.g., precheck failed)  
...
NEGATIVE TEST PASSED (Not a Test Result Type representing negetive tests results in the execution terminal log)
